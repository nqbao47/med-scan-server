...
def upload_image():
    ...
    if uploaded_image:
        ...
        with open(
            "D:/Luan Van/Project/med-scan-backend/results/output.csv",
            "r",
            encoding="utf-8",
        ) as csv_file:
            ...
            medicine_names = [row for row in csv_reader if row[-1] == "Medicine_Name"]
        ...
        for row in medicine_names:
            ...
            medicine = {"ID": row[7], "Medicine_Name": row[8]}
