...
"""
image = "D:/Luan Van/Project/med-scan-backend/GCN/data/raw/img/339.jpg"
output = "D:/Luan Van/Project/med-scan-backend/Training/figures/tess_339.jpg"
...
for i in range(n_boxes):
    if int(float(d["conf"][i])) >= 0.74:
        ...
        img = cv2.putText(
            img, text, (x, y - 1), cv2.FONT_HERSHEY_DUPLEX, 0.6, (0, 0, 255), 1
        )
...
df["xmin"], df["ymin"], df["xmax"], df["ymax"], df["Object"] = (
    xmin,
    ymin,
    xmax,
    ymax,
