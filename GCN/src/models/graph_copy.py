...
class Grapher:
    ...
    def __init__(self, filename):
        ...
        file_path = (
            "D:/Luan Van/Project/med-scan-backend/GCN/Training/data/main_data/raw/box/"
            + filename
            + ".csv"
        )
        interim_path = (
            "D:/Luan Van/Project/med-scan-backend/GCN/Training/data/main_data/labeling/"
            + filename
            + ".csv"
        )
        image_path = (
            "D:/Luan Van/Project/med-scan-backend/GCN/Training/data/main_data/raw/img/"
            + filename
            + ".png"
        )
        self.df = pd.read_csv(file_path, header=None, sep="\t")
        self.image = cv2.imread(image_path)
        self.df_withlabels = pd.read_csv(interim_path, na_values=["", "NaN"])
