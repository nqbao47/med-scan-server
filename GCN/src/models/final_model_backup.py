...
data_path = (
    ...
    + "data_embedFeatures_updateClassWeights_addFeaturesDrugnameNearestnb_AddTensorFeatures.dataset"
)
...
# best_chebconv_model
# ChebConv_training_logs

model_save = "best_chebconv_model_k_3_new_newdataset_embedFeatures_updataDataSet_updateClassWeights_noEmbedTextObject_addFeaturesDrugnameNearestnb_AddTensorFeatures_test.pth"
csv_file_path = "ChebConv_training_logs_k_3_new_newdataset_embedFeatures_updataDataSet_updateClassWeights_noEmbedTextObject_addFeaturesDrugnameNearestnb_AddTensorFeatures_test.csv"
...
parser.add_argument(
    "--model", type=str, default="ChebConv", help="GCN or ChebConv model"
)
parser.add_argument(
